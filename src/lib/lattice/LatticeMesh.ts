...
// Lattice mesh geometry constants
const LATTICE_WIDTH = 1
const LATTICE_HEIGHT = 1
const LATTICE_WIDTH_SEGMENTS = 20
const LATTICE_HEIGHT_SEGMENTS = 20

/**
 * Creates a 100x100 lattice mesh in UV space for warp deformation.
...
export function createLatticeMesh(
	...
	// Create 100x100 plane geometry (100 segments in each direction)
	...
	const geometry = new THREE.PlaneGeometry(
		LATTICE_WIDTH,
		LATTICE_HEIGHT,
		LATTICE_WIDTH_SEGMENTS,
		LATTICE_HEIGHT_SEGMENTS
	)
